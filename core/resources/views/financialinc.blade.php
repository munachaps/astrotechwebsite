        ...
        <header id="header" class="header clearfix"> 
                                    ...
                                    <nav id="mainnav" class="mainnav">
                                        ...
                                        <ul class="menu"> 
                                            ...
                                            <ul class="submenu"> 
                                                    ...
                                                    <li><a href="/pulse">Health and Wellness</a></li>                  
                                                    <li><a href="/software">Software Solutions</a></li>
                                                </ul><!-- /.submenu -->
                                            </li>
                                            <li class="">
                                                <a class="has-mega" href="#mega">Our Story</a></a>
                                                <ul class="submenu"> 
                                                    <li><a href="digitalinc">Digital Inclusion</a></li>
                                                    <li><a href="financialinc">Financial Inclusion</a></li>  
            ...
            <div class="tp-banner" >
                ...
                <li data-transition="slidedown" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                        <img src="freeimages/bzdev.jpg" alt="slider-image" />
            ...
            <div class="image-single style_1 clearfix">
                <div class="item-two-column section-iconlist">
                    ...
                    <div class="page-title">
                        ...
                        <div class="desc">
                        Through eShagi people from different parts of the country can now easily apply for product and cash loans 
                ...
                <div class="item-two-column">
                    <div class="section-progress">
                        <div class="title-section style_1">
                            ...
                            <div class="desc">
                             Since eShagi is digital , merchants can register and manage their profile in sync wih their products.
        ...
        <div class="flat-row pad-top0px pad-bottom20px">
            <div class="image-single style_1 clearfix">
                <div class="item-two-column section-iconlist">
                    <div class="title-section style_1">
                    <div class="page-title">
                            <h2 class="title">The AstroPay Wallet</h2>
                        </div> 
                        
                        <div class="desc">
                             As part of our initiative to bring convinience to transacting digitally, we are in the process of launching a digital
                             wallet that will allow for peer-to-peer lending as well as present a utility tool to 
                             manage utilty bill payments.
                        </div>                      
                    </div>
                    <div class="flat-divider d30px"></div>
                        ...
                        <div class="ft-wrap clearfix">
                            ...
                            <div class="copyright">
                                <div class="copyright-content">
                                    Copyright © 2021 <a href="" target="_blank">Astro Technology Group</a>
                                </div>
                            </div>
                        </div><!-- /.ft-wrap -->
                    </div><!-- /.flat-wrapper -->
