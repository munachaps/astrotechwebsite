...
<body class="header-sticky ">   
    ...
    <div class="boxed">
        ...
        <div id="site-content">
            <div id="page-header">
                <div class="container">
                <h3>Our bright operational strategy serves as a compass for all Astronaughts: it clearly defines the six pillars on which we are focussing to build our business sustainably.</h3>
                </div><!-- /.container -->
            </div><!-- /#page-header -->
                                ...
                                <div class="flat-portfolio portfolio-grid-alt">
                                    <div class="portfolio"> 
                                        <div class="portfolio-item item-three-column management">
                                            <div class="portfolio-wrap">
                                                <div class="portfolio-thumbnail">
                                                    <a href=""><img src="freeimages/MTN2.jpg" alt="images"></a>
                                        ...
                                        <div class="portfolio-item item-three-column management">
                                            <div class="portfolio-wrap">
                                                <div class="portfolio-thumbnail">
                                                    <a href=""><img src="freeimages/MTN3.jpg" alt="images"></a>
                                                    <div class="flat-figcaption">
                                                        <div class="project-buttons">
                                                            <a href=""><span>Quick View</span></a>
                                                        </div>
                                        ...
                                        <div class="portfolio-item item-three-column business">
                                            <div class="portfolio-wrap">
                                                <div class="portfolio-thumbnail">
                                                    <a href=""><img src="freeimages/MTN6.jpg" alt="images"></a>
                                                    <div class="flat-figcaption">
                                                        <div class="project-buttons">
                                                            <a href=""><span>Quick View</span></a>
                                                        </div>
                                                ...
                                                <div class="portfolio-info">
                                                    <div class="portfolio-info-wrap">                                                
                                                        <h6 class="portfolio-title">
                                                            <a href="">200 million</a>
                                                        </h6>
                                                        <ul class="portfolio-categories">
                                                        <h6>Fitness App users</h6>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
